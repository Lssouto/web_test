app.controller("negMercadoriaCtrl", function($scope,$http){
			...
			var loadMercadoria = function(){
					$http.get("https://testeback.herokuapp.com/produtos").then(function(valor,status){
				...
				{		
					...
					if(!produto.tpNeg || !produto.preco || !produto.qtd || !produto.nome || !produto.tipo) {
						...
						$http.get("https://testeback.herokuapp.com/produtos").then(function(valor,status){
							...
							$http.post("https://testeback.herokuapp.com/produtos",produto).then(function(valor){
